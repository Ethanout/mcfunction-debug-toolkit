...
- [安装模组并连接 AI Agent](docs/AI_AGENT_SETUP_zh-CN.md)
- [`#!` 完整语法与格式指南](docs/DEBUG_DIRECTIVES_zh-CN.md)
- [MCP 与 HTTP 协议](docs/PROTOCOL_zh-CN.md)
- [架构说明](docs/ARCHITECTURE_zh-CN.md)
- [真实数据包测试](docs/REAL_WORLD_SYNTAX_TEST_zh-CN.md)
